    ...
    projects: [
      {
        ...
        description: "A modern, responsive portfolio website showcasing web development projects and skills. Built with React and SASS.",
        type: "Full Stack",
...
export const youTubeFallbacks = {
  channelInfo: {
    ...
    description: "Web Development Tutorials - Laravel, React, PHP, and JavaScript tutorials for beginners and advanced developers.",
  ...
  playlists: [
    {
      ...
      description: "Complete Laravel framework tutorials from basics to advanced topics",
...
const fallbackDataService = { getFallbackData, getYouTubeFallback, fallbackDataMap, youTubeFallbacks };
