...
import CV from "../assets/data/Resume.pdf";
import LoadingLayout from "../Components/LoadingLayout";
import { Link } from "react-router-dom";
import { AboutSkills, AboutParagraphs } from "../assets/data/Data";
    ...
    <div className="container about__container container__flex">
     <div className="about__info">
      ...
      <p className="description">
       I have completed many training projects that contain great design and a
       lot of good skills. You can view them from{" "}
