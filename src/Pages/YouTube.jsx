        ...
        <div className="container youtube__container container__flex__column">
          ...
          <div className="youtube__intro">
            <p className="youtube__description">
              Welcome to my{' '}
              <a
                href="https://www.youtube.com/@Abdulrhman-Goda"
                target="blank"
                title="AG Youtube Channel"
              >
                YouTube channel 🎥
              </a>
              ! Here, you'll find hands-on projects, technical deep dives, and
              explorations into the ever evolving world of software development.
              Whether you're just starting or already coding, let’s learn,
              build, and improve together one project at a time.
            </p>
          </div>
